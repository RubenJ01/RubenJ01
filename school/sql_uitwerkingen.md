...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | --------- |
| [7499](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=medewerker&pos=0&sql_signature=6cd7f6d6326376d7fee2976cb9828899514d0cfde32897a690761feb07f647a0&sql_query=SELECT+*+FROM+`cursus`.`medewerker`+WHERE+`mnr`+%3D+7499) | [FOR](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=5582babee9389eaa17dd340769b76b2de575ab6e0a6167a060b8f5e552b53a14&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'FOR') | [1995-12-17](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=31ed7e4f5fdab7b16afa24e5658f2cc4e767cb75b75c153611780cada1f239ac&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`begindatum`+%3D+'1995-12-17') | 2         |
| [7499](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=medewerker&pos=0&sql_signature=6cd7f6d6326376d7fee2976cb9828899514d0cfde32897a690761feb07f647a0&sql_query=SELECT+*+FROM+`cursus`.`medewerker`+WHERE+`mnr`+%3D+7499) | [PLS](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=576fc60aac2fba74255756a4865d6ca3a8f950ef745304caeefa46fef75fc430&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'PLS') | [1996-09-11](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=cf7a8ebf1d55b9dcb780a539bb5203e84f6c78d3ad483defaec0504948d6b636&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`begindatum`+%3D+'1996-09-11') | *NULL*    |
| [7566](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=medewerker&pos=0&sql_signature=c492f5f86bf3ffc13e94f7b6fdb469ea94ceaba634cf6c5a6ebca4003ccea93f&sql_query=SELECT+*+FROM+`cursus`.`medewerker`+WHERE+`mnr`+%3D+7566) | [FOR](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=5582babee9389eaa17dd340769b76b2de575ab6e0a6167a060b8f5e552b53a14&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'FOR') | [1996-02-05](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=d7a07b64589c335e9ba55422b693ce65daae1be028d1cb520ca5cf32dd2f84e5&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`begindatum`+%3D+'1996-02-05') | 3         |
...
| [COUNT(cursist)](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=inschrijving&sql_query=SELECT+COUNT(cursist)%2C+cursus%2C+evaluatie+FROM+inschrijving+GROUP+BY+cursus++ ORDER+BY+`COUNT(cursist)`+ASC&sql_signature=ba70d560d337ba7ef0ac3307c712bb0f31703938ee1eda52fa292055e2d5da03&session_max_rows=25&is_browse_distinct=0) | [cursus](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=inschrijving&sql_query=SELECT+COUNT(cursist)%2C+cursus%2C+evaluatie+FROM+inschrijving+GROUP+BY+cursus++ ORDER+BY+`inschrijving`.`cursus`+ASC&sql_signature=d93695a70751fc1047869929107a29177063594921906e889965a411a754c895&session_max_rows=25&is_browse_distinct=0) | [evaluatie](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=inschrijving&sql_query=SELECT+COUNT(cursist)%2C+cursus%2C+evaluatie+FROM+inschrijving+GROUP+BY+cursus++ ORDER+BY+`inschrijving`.`evaluatie`+ASC&sql_signature=6efe97be0a89aba26e405c579e51cfe53586a9a0400a0814314bd6bf1f8cc5dd&session_max_rows=25&is_browse_distinct=0) |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 8                                                            | [FOR](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=5582babee9389eaa17dd340769b76b2de575ab6e0a6167a060b8f5e552b53a14&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'FOR') | 2                                                            |
| 4                                                            | [OAG](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=20d67b0f3f9da34e017749d363b788878040fcd2c196fa22c5a651bf5e3d011d&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'OAG') | 4                                                            |
| 3                                                            | [PLS](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=576fc60aac2fba74255756a4865d6ca3a8f950ef745304caeefa46fef75fc430&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'PLS') | *NULL*                                                       |
| 2                                                            | [REP](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=a481809648c97050993e6375c9f4d8d029d83aa7558b2edbbb09dc0f012f3119&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'REP') | 5                                                            |
| 9                                                            | [S02](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=cb7d2b6be8d788d90b6f8030205b3287d129ebacfd46d5a7c15e123407bb5b71&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'S02') | 4                                                            |
...
| -------------- | ------------------------------------------------------------ | --------- |
| 26             | [FOR](http://localhost/phpmyadmin/index.php?route=/sql&db=cursus&table=uitvoering&pos=0&sql_signature=5582babee9389eaa17dd340769b76b2de575ab6e0a6167a060b8f5e552b53a14&sql_query=SELECT+*+FROM+`cursus`.`uitvoering`+WHERE+`cursus`+%3D+'FOR') | 2         |
